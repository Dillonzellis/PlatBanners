...
<head>
	<title>Platinum FCU - General Services</title>
	<!-- Required meta tags -->
	<meta charset="utf-8">
	...
	<section class="overview-block-ptb1 iq-over-black-10 jarallax iq-breadcrumb3 text-left iq-font-white" style="background-color: #575757;">
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-12">
					<div class="iq-mb-0">
						<h2 class="iq-font-white iq-tw-6 custom-header">General Services</h2>
					</div>
				</div>
			</div>
		</div>
													...
													<div id="accordion">
														...
														<div class="card">
															<div class="card-header" id="headingFifteen">
																<h5 class="mb-0">
																	<button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseFifteen" aria-expanded="true" aria-controls="collapseFifteen">Wealth Management
																	</button>
																</h5>
															</div>
															<div id="collapseFifteen" class="collapse" data-parent="#accordion">
																<div class="card-body">
																	<div class="row">
																		<div class="col-lg-12">
																			<p align="center"><img src="../images/mwm.jpg" border="0" alt="Member Wealth Management"></p>

																			<h3 style="color:#104c92;"><strong>Investments, Insurance & Financial Planning</strong></h3>
																			<p>When it comes to planning for your future and dealing with everything from college planning, retirement planning or even estate strategies, it can help to have someone who's experienced and knowledgeable to assist you along the way. The Member Wealth Management team works closely with our members to provide them with strategies that help with their unique situations. </p>


																			<h3 style="color:#104c92;"><strong>Member Wealth Management services include:</strong></h3>
																			<p>
																			<ul>
																				<li>Retirement and income strategies
																				</li>
																				...
																				<li>Wealth transfer and estate planning strategies
																				</li>
																			</ul>
																			</p>


																			<h3 style="color:#104c92;"><strong>Investment services include:</strong></h3>
																			<p>
																			<ul>
																				<li>Mutual funds</li>
																				<li>Fixed and Variable annuities</li>
																				<li>Traditional and Roth IRA's</li>
																				<li>529 plans (college savings plans)</li>
																				<li>Individual stocks and bonds</li>
																				<li>401(k) and other retirement plans</li>

																			</ul>
																			</p>


																			<h3 style="color:#104c92;"><strong>Insurance services include:</strong></h3>
																			<p>
																			<ul>
																			...
																			<p>For more information about Member Wealth Management, please call <strong><em><u>{AMIN MITHA}</u></em></strong> today at <strong><em><u>{678-923-8489} or {amitha@financialguide.com}</u></em></strong> to schedule an appointment.</p>

																			<p style="font-size: 10px;">Products and Services are: NOT A CREDIT UNION DEPOSIT; NOT NCUA INSURED; NOT INSURED BY ANY FEDERAL GOVERNMENT AGENCY; NOT GUARANTEED BY THE CREDIT UNION; MAY GO DOWN IN VALUE</p>

																			<p style="font-size: 10px;">Securities, Investment Advisory and Financial Planning services offered through qualified registered representatives of MML Investors Services, LLC, <span style="color: blue;"><strong><a href="#" data-remodal-target="sipc">Member SIPC</a>:</strong></span> 222 Central Park Ave Suite 1100 Virginia Beach VA 23462 (757) 490-9041. Member Wealth Management and the Credit Unions are not a subsidiary or affiliate of MML Investors Services, LLC and affiliated companies. CRN202104-246823</p>

																			<p style="font-size: 10px;">States licensed to sell insurance: DC, DE, GA, MD, NC, NJ, OH, RI, TX, UT, VA, WA<br>
																				States licensed to sell securities: DC, DE, GA, MD, NC, NJ, OH, RI, TX, UT, VA, WA
																			</p>
																			<style>
																				ol {
																					padding-left: 40px;
																			...
																			<h3 style="color:#104c92;"><strong>MassMutual Social Security Information Video Series</strong></h3>
																			<p>This series is designed to be viewed one segment at a time or streamed in full. The content is intended as general information on Social Security retirement benefits. Any questions regarding your unique situation should be discussed with your personal legal and financial advisors or by contacting the Social Security Administration.</p>

																			<ol>
																				<li><a href="#" data-remodal-target="brainshark-1">Answers to Some Important Questions About Social Security Program</a>
																				</li>

																				<li><a href="#" data-remodal-target="brainshark-2">How Do I Qualify?</a>
																				</li>

																				<li><a href="#" data-remodal-target="brainshark-3">Filing Strategies for Single and Married!</a>
																				</li>

																				<li><a href="#" data-remodal-target="brainshark-4">Restricted Filing Married & Divorced</a>
																				</li>

																				<li><a href="#" data-remodal-target="brainshark-5">Restricted Filing for Widows & Widowers</a>
																				</li>

																				<li><a href="#" data-remodal-target="brainshark-6">When are social Security Benefits subject to Income Tax</a></li>

																				<li><a href="#" data-remodal-target="brainshark-7">An Early Filing Decision</a></li>

																				<li><a href="#" data-remodal-target="brainshark-8">Fitting into the Overall Plan for Income In Retirement</a></li>
