...
<head>
    <title>Platinum FCU - Services</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <section class="overview-block-ptb1 iq-over-black-10 jarallax iq-breadcrumb3 text-left iq-font-white" style="background-color: #575757;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="iq-mb-0">
                        <h2 class="iq-font-white iq-tw-6 custom-header">Services</h2>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="tab-pane fade show active">
                                <div class="row">
                                    <div class="col-sm-12">
										...
										<p>At Platinum Federal Credit Union, we offer a wide variety of services to meet the needs of our members. in the previous years we have listened to your suggestions and are glade to implement your suggestions so that we can proved a better service to the community at large. We would still love to hear from you if there are any more services we can add that would be beneficial. Please look in to the different kinds of services that we offer and take advantage of them. 
</p>
