...
<head>
	<title>Platinum FCU - Business Services</title>
	<!-- Required meta tags -->
	<meta charset="utf-8">
	...
	<section class="overview-block-ptb1 iq-over-black-10 jarallax iq-breadcrumb3 text-left iq-font-white" style="background-color: #575757;">
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-12">
					<div class="iq-mb-0">
						<h2 class="iq-font-white iq-tw-6 custom-header">Business Services</h2>
					</div>
				</div>
			</div>
		</div>
										...
										<div class="tab">
											...
											<div class="tab-content">
												<div class="tab-pane active">
													<div class="row">
														<div class="col-sm-12">
															<h3 class="iq-pb-25">Business Services</h3>
														</div>
													</div>
													<div id="accordion">
														<div class="card">
															<div class="card-header" id="headingOne">
																<h5 class="mb-0">
																	<button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Armored Car Services
																	</button>
																</h5>
															</div>
															<div id="collapseOne" class="collapse" data-parent="#accordion">
																<div class="card-body">
																	<div class="row">
																		<div class="col-sm-12">
																			<p>EXPECT A NEW STANDARD OF SERVICE</p>
																			<p>Abram was founded with the specific
purpose of transforming the cash in
transit industry, through the heart of
a servant. Our vision is to positively
transform lives in the communities
we serve.</p>
																			<p>Let us know how we can create personalized
solutions for your needs.</p>
																			<p>Examples Of Retail Services We Offer:</p>
<ul class="listing-mark iq-tw-6 iq-font-black iq-pb-15">
														<li>Deposit pick up and change order
delivery</li>
														<li>Secure web-based ordering</li>
	<li>Tailored customer dashboard</li>
	<li>Smart Safe solutions with same day
credit</li>
	<li>Integrated track and trace platform
provides real time data on your
shipments</li>
																			</ul>
																			<p>To learn more about our partnership with Abram call 770-855-2989 or email <a href="mailto:cashservices@abramarmored.com">cashservices@abramarmored.com</a>.</p>
														...
														<div class="card">
															...
															<div id="collapseCheck" class="collapse" data-parent="#accordion">
																<div class="card-body">
																	<p><a href="#" data-remodal-target="deluxeCheckBiz"><img src="../images/BusinessCheckSite.jpg" alt="business check site image"></a></p>
																</div>
															</div>
														</div>
														...
														<div class="card">
															<div class="card-header" id="headingFour">
																<h5 class="mb-0">
																	<button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseFour" aria-expanded="true" aria-controls="collapseFour">Letter of Credit
																	</button>
																</h5>
															</div>
															<div id="collapseFour" class="collapse" data-parent="#accordion">
																<div class="card-body">
																	<div class="row">
																		<div class="col-sm-12">
																			<p>Platinum Federal Credit Union provides Letters of Credit to support your business needs. Be it a Standby Letter of Credit or an Import / Export Letter of Credit, we can meet your need. We have issued letters of credit for Georgia Lottery, Gasoline Companies, Utility Companies, etc.</p>
																			<ul class="listing-mark iq-tw-6 iq-font-black iq-pb-15">
																				<li>Letters of Credit are offered an a secured basis only</li>
																				<li>Fees will apply based upon type of letter of credit requested</li>
																			</ul>

																			<p><a href="rates.php">Click Here for Fee Schedule</a>.</p>
																			<p><strong>Account Access</strong><br>
														...
														<div class="card">
															<div class="card-header" id="headingFive">
																<h5 class="mb-0">
																	<button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseFive" aria-expanded="true" aria-controls="collapseFive">Merchant Services
																	</button>
																</h5>
															</div>
															<div id="collapseFive" class="collapse" data-parent="#accordion">
																<div class="card-body">
																	<div class="row">
																		<div class="col-sm-12">
																			<p>Credit and debit cards are today's consumer currency. So, for businesses, accepting credit cards is no longer optional – your customers and vendors expect it.</p>
																			<p>Tru Treasury Merchant Services is designed to meet ALL our merchant members payment needs, no matter what software they use, what processer they prefer or equipment they need to run their business’ We are open for you.
																			...
																			<p><a href="https://www.trutreasury.com/pfcu-merchant-services" target="_blank">Click here to get in touch or to have your statement analyzed.</a></p>
																			<p>Access your accounts at PFCU 24 hours a day with Home Banking.</p>
																		</div>
																	</div>
																</div>
															</div>
														...
														<div class="card">
															<div class="card-header" id="headingSix">
																<h5 class="mb-0">
																	<button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseSix" aria-expanded="true" aria-controls="collapseSix">Merchant Capture Services
																	</button>
																</h5>
															</div>
															<div id="collapseSix" class="collapse" data-parent="#accordion">
																<div class="card-body">
																	<div class="row">
																		<div class="col-sm-12">
																			<p><strong>IS MERCHANT CAPTURE FOR YOUR BUSINESS?</strong></p>
																			<p>Does your business make large number of check deposits, or do you drive to PFCU often to make check deposits? Do you receive checks with large dollar amounts? If you answered yes, Merchant Capture is for your business!</p>
																			<ul class="listing-mark iq-tw-6 iq-font-black iq-pb-15">
																				<li>Deposit checks electronically from your office or shop desk.</li>
																				<li>Make deposits anytime electronically and securely.</li>
																				<li>No more driving to the branch to make a deposit.</li>
																				<li>Save time preparing deposits. No more filling out deposit slips by hand.</li>
																				<li>Consolidate funds from remote locations into your PFCU account.</li>
																				<li>Reduce check fraud and find out about returned items quicker.</li>
																			</ul>

																			<p><strong>IT'S A SIMPLE PROCESS:</strong></p>
																			<ul class="listing-mark iq-tw-6 iq-font-black iq-pb-15">
																				<li>Log on to the Internet to our secure Merchant Capture site.</li>
																				<li>Feed your checks into your scanner. The scanner scans both sides of the check in a single pass.</li>
																				<li>View images of the scanned checks from your PC. The dollar amounts are read and totaled.</li>
																				<li>Click "submit deposit" to send via a secure Internet Connection.</li>
																				<li>Funds are deposited.</li>
																			</ul>

																			<p><strong>WHAT IS NEEDED:</strong></p>
																			<ul class="listing-mark iq-tw-6 iq-font-black iq-pb-15">
																				<li>PC with Windows 7, 8 or 10 32bit or 64bit and USB 2.0 port</li>
																				<li>Scanner provided by PFCU</li>
																				<li>Internet connection</li>
																				<li>Platinum Federal Credit Union business account</li>
																			</ul>
																...
																<div class="card-body">
																	<div class="row">
																		<div class="col-sm-12">
																			...
																			<p>Our standard OD Privilege Fee of $25.00 will be imposed for overdrafts created by checks, ACH, ATM withdrawals, everyday debit card transactions, in-person withdrawals, or by other electronic means. If your account balance remains overdrawn for longer than 3 days, we will charge your account a collection fee of $15.00.</p>
																...
																<div class="card-body">
																	<div class="row">
																		<div class="col-sm-12">
																			...
																			<p>For your convenience, you can complete the <a href="https://www.platinumfcu.org/pages/wire-transfer-form.php" target="_blank">Wire Transfer Form</a> online</p>
																		</div>
																	</div>
																</div>
															</div>
