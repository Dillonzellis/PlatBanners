...
<head>
    <title>Platinum FCU - Business Loans</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <section class="overview-block-ptb1 iq-over-black-10 jarallax iq-breadcrumb3 text-left iq-font-white"
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="iq-mb-0">
                        <h2 class="iq-font-white iq-tw-6 custom-header">Business Loans</h2>
                    </div>
                </div>
            </div>
        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-12">
                                                                            <p>Give your business increased purchasing
                                                                                power with the PFCU's Small Business
                                                                                MasterCard® Credit Card. Appreciate the
                                                                                convenience, security and worldwide
                                                                                acceptance at over 28 million locations.
                                                                            </p>
                                                                            <p>The PFCU's Business MasterCard Credit
                                                                                Card is accepted everywhere you see the
                                                                                MasterCard symbol. PFCU's MasterCard
                                                                            ...
                                                                            <p><strong>Account Access</strong><br>
                                                                                ...
                                                                                PFCU 24 hours a day with <a href="#"
                                                                                    data-remodal-target="ezcard">Credit
                                                                                    Card Online</a> or 1-877-PFCUTEL
                                                                                (732-8835).</p>
                                                                            <p align="center"><img
                                                                                    src="../images/business/business-cc.jpg"
