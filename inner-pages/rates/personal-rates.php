...
<head>
    <title>Platinum FCU - Loan Rates</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <section class="overview-block-ptb1 iq-over-black-10 jarallax iq-breadcrumb3 text-left iq-font-white" style="background-color: #575757;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="iq-mb-0">
                        <h2 class="iq-font-white iq-tw-6 custom-header">Rates & Fees - Personal</h2>
                    </div>
                </div>
            </div>
        </div>
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div id="collapseOne" class="collapse" data-parent="#accordion">
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        <div class="col-sm-12">
                                                                            <p><strong>Loan Rates are accurate as of January 2023. Rates and other terms may change at any time without prior notice. For variable rate loans a floor rate may be applicable.</strong></p>
                                                                            ...
                                                                            <table class="table table-bordered table-striped">
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>As low as 4.74%</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td><strong>Pre-Owned Auto Loan</strong></td>
                                                                                        <td>As low as 4.99%</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        <div class="col-sm-12">
                                                                            ...
                                                                            <p><em>*Dividend Rate is accurate as of <strong>April 2023</strong>. Rates and other terms may change at any time without prior notice. After your certificate is opened, the dividend rate is fixed for the term. A penalty is imposed for early withdrawal. Fees could reduce earnings on the account.</em></p>
                                                                            <table class="table-bordered table-striped" align="center" style="width:95%;">
                                                                                <thead>
                                                                                    <tr>
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td bgcolor="#D3D3D3">
                                                                                            <p align="left"><strong>12 months</strong><br>
                                                                                                $1,000 - $9,999<br>
                                                                                                $10,000 - $24,999<br>
                                                                                                $25,000 - $99,999<br>
                                                                                                above $100,000</p>
