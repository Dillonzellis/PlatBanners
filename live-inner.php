...
<head>
    <title>Platinum FCU - Deposit Products</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body>
    ...
    <section class="tw-mt-[76px] tw-bg-brandingGreen-400">
      <div class="">
        ...
        >
          <img
            src="../images/inner-header/inner-pattern.png"
            alt=""
            class="tw-absolute tw-hidden tw-h-[250px] tw-w-[675px] tw-object-cover lg:tw-block"
            srcset=""
          />
          <div
            class="tw-mx-auto tw-flex tw-w-full tw-max-w-[1140px] tw-px-[15px]"
          >
            <h1
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-12 iq-mtb-15">
                        ...
                        <ul class="nav nav-pills tabs-left" id="pills-tab" >
                          ...
                          <div class="iq-mt-30 iq-pall-20" style="background-color:#b2191e"">
                            <h6 style="color:white" class="iq-tw-6 iq-font-black small-title white">How can We Help You?</h6>
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-12 iq-mtb-15">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active">
                                <div class="row">
                                    <div class="col-sm-12">
										<p>Our community is known to keep the business within the community. Our community trade associations and the credit unions are a great example of this principle. That's why at PFCU you’ll find the products and services to meet your business banking needs – from checking and mobile banking for managing your day-to-day finances to a complete suite of complex cash management needs. When you choose PFCU, you’ve got a banking partner who knows a thing or two about doing business within the community. Together we continue to grow stronger.</p>
                                    </div>
                                </div>
                            </div>
