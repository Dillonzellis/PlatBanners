...
<head>
    <title>Platinum FCU - Personal Deposit Products</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <section class="overview-block-ptb1 iq-over-black-10 jarallax iq-breadcrumb3 text-left iq-font-white"
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="iq-mb-0">
                        <h2 class="iq-font-white iq-tw-6 custom-header">Deposit Products - Personal</h2>
                    </div>
                </div>
            </div>
        </div>
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        <div class="col-sm-12">
                                                                            ...
                                                                            <ul
                                                                                class="listing-mark iq-tw-6 iq-font-black">
                                                                                <li>$50 Minimum balance to open</li>
